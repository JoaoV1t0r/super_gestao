        ...
        <div class="col-md">
            ...
            <div class="informacao-pagina">
                ...
                <div class="form-floating mb-2">
                    <input name="email" type="text" class="form-control" id="floatingInputGrid" placeholder="E-mail" value="{{old('email')}}" >
                ...
                <div class="form-floating mb-2">
                    <input name="senha" type="password" class="form-control" id="floatingInputGrid" placeholder="Senha" value="{{old('senha')}}" >
